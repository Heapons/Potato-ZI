...
const GLOBAL_BELL_DELAY                = 3;     // delay in seconds for death bell         //
/////////////////////////////////////////////////////////////////////////////////////////////
// Zombie Stats |------------------------------------------------------------------------- //
/////////////////////////////////////////////////////////////////////////////////////////////
// --------------------------------------------------------------------------------------- //
...
const FX_SPIT_SPLAT                 = "spell_skeleton_goop_green"
...
const FX_SPIT_HIT_PLAYER            = "breadjar_impact"
const FX_SPIT_IMPACT_GROUND         = "unusual_robot_radioactive"
const FX_SPIT_IMPACT_SMOKE          = "spell_skeleton_goop_green"
...
const SFX_ZOMBIE_SPIT_START   = "infection_potato/sniper_spit_start.wav"
const SFX_ZOMBIE_SPIT_END     = "infection_potato/sniper_spit_end.wav"
const SFX_ENGI_EMP            = "infection_potato/engineer_emp_0%d.wav"
const SFX_EMP_EXPLODE         = "infection_potato/sfx_infection_emp_grenade_explode1.wav"
...
const ZBIT_PARTICLE_HACK           = 0x1 // 1
const ZBIT_PENDING_ZOMBIE          = 0x2 // 2
const ZBIT_PENDING_UNZOMBIE        = 0x4 // 4
const ZBIT_IS_UNJUMBLER            = 0x4 // 4
const ZBIT_DEAD_ZOMBIE             = 0x8 // 8
const ZBIT_ZOMBIE                  = 0x10 // 16
const ZBIT_SURVIVOR                = 0x20 // 32
const ZBIT_SNIPER_CHARGING_SPIT    = 0x40 // 64
const ZBIT_SPY_IN_REVEAL           = 0x80 // 128
const ZBIT_REVEALED_BY_SPY         = 0x100 // 255
const ZBIT_HASNT_HEARD_READY_SFX   = 0x400 // 1024
const ZBIT_MEDIC_IN_HEAL           = 0x800 // 2048
const ZBIT_HEALING_FROM_ZMEDIC     = 0x1000 // 4096
const ZBIT_HASNT_HEARD_DENY_SFX    = 0x2000 // 8192
const ZBIT_IS_ULTING               = 0x4000 // 16384
const ZBIT_HAS_HUD                 = 0x8000 // 32768
const ZBIT_WAS_GIVEN_HUD_INFO      = 0x10000 // 65536
const ZBIT_IS_DEVELOPER            = 0x40000 // 262144
const ZBIT_IS_NOT_DEVELOPER        = 0x80000 // 524288
const ZBIT_MUST_EXPLODE            = 0x40000 // 262144
const ZBIT_OUT_OF_COMBAT           = 0x80000 // 524288
const ZBIT_THE_OMBUDSMAN           = 0x100000 // 1048576
const ZBIT_SOLDIER_IN_POUNCE       = 0x400000 // 4194304
const ZBIT_SCOUT_HAS_TRIPLE_JUMPED = 0x800000 // 524288
const ZBIT_DEMOCHARGE              = 0x1000000 // 1048576
const ZBIT_PYRO_DONT_EXPLODE       = 0x2000000 // 2097152
